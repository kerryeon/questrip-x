...
/// 담당자: 김호, 구본근
///
class _QuestAboutState extends State<QuestAboutWidget> {

  final QuestAboutController _controller;

  _QuestAboutState(this._controller);
...
class QuestAboutWidget extends StatefulWidget {

  final QuestAboutController _controller;

  QuestAboutWidget(this._controller);

  @override
  State<QuestAboutWidget> createState() => _QuestAboutState(_controller);
