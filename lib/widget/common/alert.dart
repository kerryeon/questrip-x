...
/// 알림창을 띄웁니다.
void dialog(final context, final String msgId, { Runnable onConfirm, Runnable onCancel }) {
  onCancel == null
...
void dialogFailed(final context, final Failed failed,
...
void _dialogSimple(final context, final String msg, { Runnable onConfirm }) async {
...
void _dialogAsk(final context, final String msg, { Runnable onConfirm, Runnable onCancel }) {
  showDialog(context: context,
